...
/*
  ...
  Compile as:
                                                                                      ...
                                                                                      PSRAM: Enabled
*/
const char* SSID1 = "Ko Cho Đâu";
const char* PWD1 = "123456789";
...
#define API_KEY "AIzaSyALLncG_4h_lJUqHZFoGk3pBwMxG0K5I88"
#define DATABASE_URL "pbl4-aipt-default-rtdb.firebaseio.com"
#define USER_EMAIL "phamnhutcongviec@gmail.com"
#define USER_PASSWORD "khongbiet@7"
...
//  WiFi.begin(SSID1, PWD1);
  ...
  String Link = String(ip[0])+"."+String(ip[1])+"."+String(ip[2])+"."+String(ip[3]);
  Link += "/mjpeg/1";
  Serial.println(Link);
  ...
  Firebase.setString(fbdo,"/LinkStream", Link);
